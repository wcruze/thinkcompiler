...
//hace un barrido de informacion para hacer una recoleccion de los datos a analizar
//It does a sweep of information to make a collection of the data to be analyzed
function barrido(data3) {
    ...
    for (var x = 0; x <= data3.length; x++) {
        ...
        if (data3[x] == (";") || data3[x] == ("long") || data3[x] == ("String") || data3[x] == (">=") ||
            ...
            localStorage.setItem(x4, JSON.stringify(informacion(data3[x])))
...
//Detecta los errores de escritura de variables previamente recogidas
//Detects write errors of previously collected variables
function errores(input) {
    ...
    for (var x = 0; x <= input.length; x++) {
        ...
        if (input[x] == "Int" || input[x] == "INt" || input[x] == "INT" ||
...
// detectamos las variables y sus valores
//We detect variables and their values
function deteccion(recibir) {
...
//detecta errores sintactico
//Detects errors the type syntactcc
function deteccion2(recibir) {
    var devo;
    for (var x = 0; x < recibir.length; x++) {
        ...
        if (recibir[x] == "String") {
            ...
            if (recibir[x + 2] == "=" || recibir[x + 2] == ";") {
                ...
                // agregamos los valores en el session storage para luego ser analizados
                // y verificar si estan repetidas las variables

                // We add the values in the session storage to be analyzed And check if 
                ...
                if (nc2 == "=") {
                    ...
                    if (tiene_numeros(nc3) == true) {
                        ...
                        devo = "Error: 15 - De tipo sintacticos se le asigno un valor incorrecto a String ";
                    }
                    // nc3 capturamos y enviaremos a una area donde se muestren
                    // la variables declaradas y su valor
            ...
            if (recibir[x + 2] == "=" || recibir[x + 2] == ";") {
                ...
                if (nc2 == "=") {
                    ...
                    if (nc3.includes(".") == true) {
                        ...
                        devo = "Error: 14 - De tipo sintactico se le asigno un valor incorrecto a int ";
                    }
                    // nc3 capturamos y enviaremos a una area donde se muestren
                    // la variables declaradas y su valor
            ...
            if (recibir[x + 2] == "=" || recibir[x + 2] == ";") {
                ...
                if (nc2 == "=") {
                    ...
                    if (!nc3.includes("true") != nc3.includes("false")) {
                        ...
                        devo = "Error: 17 - De tipo sintacto se le asigno otro valor a boolean ";
                    }
            ...
            if (recibir[x + 2] == "=" || recibir[x + 2] == ";") {
                ...
                if (nc2 == "=") {
                    ...
                    if (nc3.length > 3) {
                        ...
                        devo = "Error: 16 - De tipo sintactico se le asigno una cadena  a char ";
                    }
...
// analizamos la sintaxis del if y verificamos que  el comparador sea correcto
//We analyze the syntax of the IF and verify that the compared is correct
function ultima(data) {
...
// extraemos la informacion del sessionstorage y analizamos las posiciones para verificar
// si hay palabras repetidas

//We extract the information from the Sessionstorage and analyze
//the positions to verify If there are repeated words
...
//Verify that the string has numbers and if you have it gives an error
...
// verificamos que estamos trabajando con java
//We verify that we are working with Java
function verificador(info) {
    var result = false;
...
//We find what are the variables
...
//Collect data to put them in a dynamic table
